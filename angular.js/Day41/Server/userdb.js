...
app.get("/users", (request, response) => {
    ...
    mongoClient.connect(dbURL, {useNewUrlParser:true}, (error, client) => {
        ...
        let cursor = db.collection("my").find();
        let users = [];
...
app.post("/users", (request, response) => {
    ...
    mongoClient.connect(dbURL, {useNewUrlParser:true}, (error, client) => {
        ...
        db.collection("my").insertOne(userDocument, (err, res) => {
            if(err) {
...
app.get("/users/:id", (request, response) => {
    ...
    mongoClient.connect(dbURL, {useNewUrlParser:true}, (error, client) => {
        ...
        db.collection("my").findOne({_id:id})
        .then((doc) => {
            if(doc != null) {
                response.json(doc);
            } else {
...
app.delete("/users/:id", (request, response) => {
    ...
    mongoClient.connect(dbURL, {useNewUrlParser:true}, (error, client) => {
        ...
        db.collection("my").deleteOne({_id:id})
        .then((doc) => {
            response.json(doc);
            client.close();
        })
...
app.put("/users/:id/:age", (request, response) => {
    ...
    mongoClient.connect(dbURL, {useNewUrlParser:true}, (error, client) => {
        ...
        db.collection("my").updateOne({_id:id}, {$set:{age: ageNew}})
        .then((doc) => {
            response.json(doc);
            client.close();
        })
